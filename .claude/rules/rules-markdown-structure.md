...
The `enforce-enhanced-rules.ts` PreToolUse hook validates:
...
- The enhanced-rules plugin enforces this structure on all Write/Edit operations to `.claude/rules/*.md` files
